                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        ...
                        <div class="btn-group mr-2">
                            <a href="/entreprise/logout">
                                <button class="btn btn-lg btn-danger btn-block"><span data-feather="sign-out"></span>logout</button>
                            </a>
                        </div>
                                ...
                                <div class="p-5">
                                    ...
                                    <form method="post" action="/update" class="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nom" value="{{$company['nom']}}" class="form-control form-control-user"  aria-describedby="le nom d'entreprise" placeholder="nom d'entreprise">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Logo D'entreprise</label>
                                            <input type="file" name="logo" class="form-control-file" id="logo" placeholder="Password">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Site</label>
                                            <input type="text" name="site" value="{{$company['site']}}" class="form-control form-control-user"  aria-describedby="" placeholder="http://www.yourcompany.com">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Addresse</label>
                                            <input type="text" name="addresse" value="{{$company['addresse']}}" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="" placeholder="Addresse">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Ville</label>
                                            <input type="text" name="city" value="{{$company['city']}}" class="form-control form-control-user"  aria-describedby="" placeholder="ville">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Pays</label>
                                            <input type="text" name="county" value="{{$company['country']}}" class="form-control form-control-user"  aria-describedby="" placeholder="country">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Secteur D'activit</label>
                                            <input type="text" name="activity" value="{{$company['activity']}}" class="form-control form-control-user"  aria-describedby="" placeholder="activity">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Telephone</label>
                                            <input type="text" name="phone" value="{{$company['phone']}}" class="form-control form-control-user"  aria-describedby="" placeholder="Tel:">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Email</label>
                                            <input type="email" name="email" value="{{$company['email']}}" class="form-control form-control-user"  aria-describedby="" placeholder="Email Address">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Main Contact</label>
                                            <input type="text" name="maincontact" value="{{$company['maincontact']}}" class="form-control form-control-user"  aria-describedby="" placeholder="main contact">
                                        </div>
